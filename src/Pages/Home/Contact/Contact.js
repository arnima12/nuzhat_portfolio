...
const Contact = () => {
    ...
    if (state.succeeded) {
        return (
            <div className="flex flex-col justify-center items-center bg-transparent bg-opacity-25 bg-slate-950 mx-8 rounded-xl shadow-xl py-16 mt-24">
                <div className="text-4xl text-rose-800 font-semibold">Thanks for contacting with me!</div>
                <button
                    onClick={resetForm}
    ...
    return (
        <div className="mt-24 text-white bg-transparent bg-opacity-25 bg-slate-950 mx-8 rounded-xl shadow-xl py-16" id="contact">
                ...
                <form action="https://formspree.io/f/movqwkkz" method="POST" onSubmit={(e) => { handleSubmit(e) }}>
                    <div className="flex flex-col lg:flex-row-reverse gap-24 text-xl w-full">
                        <div className="flex flex-col gap-4 lg:w-[20rem] justify-center">
                            ...
                            <p className="font-medium text-white text-center lg:text-left">tnuzhat848@gmail.com</p>
                        </div>
