        ...
        <div className="container mx-auto px-4" id="intro">
            <div className="intro hero min-h-screen">
                <div className="hero-content flex flex-col lg:flex-row-reverse">
                    <div className="">
                        <img src={nuzhat} alt="Prothoma" className=" hidden lg:flex" />
                    </div>
                    <div className="w-1/2">
                        ...
                        <h1 className="subtitle text-3xl md:text-5xl font-semibold mt-8 text-white text-animate leading-8" data-aos="fade-right" data-aos-duration="1000">Software Quality Assurance Engineer</h1>
