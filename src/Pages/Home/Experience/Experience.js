        ...
        <div className="mt-24 text-white">
            ...
            <div className="flex flex-col items-center mt-24">
                {experience.map((exp, index) => (
                    <div key={index} className="flex justify-center pb-10 relative">
                        <div className="mb-4 w-[40rem] flex items-center">
                            <h3 className="text-2xl px-4 text-rose-600">{exp.year}</h3>
                        </div>
